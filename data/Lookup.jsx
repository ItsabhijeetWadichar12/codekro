...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Codekro',
  SIGNIN_SUBHEADING: 'To use Codekro you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Codekro, you agree to the collection of usage data for analytics.',
